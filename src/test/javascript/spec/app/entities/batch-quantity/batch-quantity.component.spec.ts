...
import { BatchQuantityComponent } from 'app/entities/batch-quantity/batch-quantity.component';
...
describe('Component Tests', () => {
    describe('BatchQuantity Management Component', () => {
        let comp: BatchQuantityComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BatchQuantityComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.batchQuantities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
